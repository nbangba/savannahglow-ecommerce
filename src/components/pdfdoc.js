          ...
          <Text>Savannah Glow</Text>
            <View style={styles.recieptInfo}>
              ...
              <View style={styles.view}>
                ...
                <Text style={{...styles.text,margin:5}}>3/04/2021</Text>
                </View>
                <View style={styles.view}>
                <Text style={{...styles.text,margin:5,fontWeight:'bold'}}>Payment:</Text>
                <Text style={{...styles.text,margin:5}}>PayStack</Text>
                </View>
              </View>
              <View style={{width:'50%'}}>
               <View style={styles.view}>
                <Text style={{...styles.text,margin:5,fontWeight:'bold'}}>Receiver:</Text>
                <Text style={{...styles.text,margin:5}}>Lukman Ahmed</Text>
                </View>
              </View>
            </View>
            ...
            { order.order.items.map((item)=>
              <View style={styles.view}>
                ...
                <View>
                <Text style={{...styles.text,textAlign:'right',paddingRight:15}}>{item.quantity}</Text>
                </View>
                <View>
                ...
                <Text style={{...styles.text,textAlign:'right',paddingRight:17}}>0.00</Text>
                </View>
                <View style={{...styles.view,justifyContent:'flex-end'}}>
